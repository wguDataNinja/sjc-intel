...
**Simulation identity:** backtest `hermes-sjc-v1`, simulated week `2025-08-18` → `2025-08-24`.
...
- The current date is `2025-08-24`. Any source dated after `2025-08-24` does
...
7. **Resolve aliases/entities** — reconcile names using only evidence available
   by `2025-08-24`. Do not use future aliases.
...
- Never read beyond `2025-08-24` in any feed or file.
