...
**Simulation identity:** backtest `hermes-sjc-v1`, simulated week `2026-07-20` → `2026-07-26`.
...
- The current date is `2026-07-26`. Any source dated after `2026-07-26` does
...
7. **Resolve aliases/entities** — reconcile names using only evidence available
   by `2026-07-26`. Do not use future aliases.
...
- Never read beyond `2026-07-26` in any feed or file.
