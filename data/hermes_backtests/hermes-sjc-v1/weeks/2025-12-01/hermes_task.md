...
**Simulation identity:** backtest `hermes-sjc-v1`, simulated week `2025-12-01` → `2025-12-07`.
...
- The current date is `2025-12-07`. Any source dated after `2025-12-07` does
...
7. **Resolve aliases/entities** — reconcile names using only evidence available
   by `2025-12-07`. Do not use future aliases.
...
- Never read beyond `2025-12-07` in any feed or file.
