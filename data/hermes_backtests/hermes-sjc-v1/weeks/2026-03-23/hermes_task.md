...
**Simulation identity:** backtest `hermes-sjc-v1`, simulated week `2026-03-23` → `2026-03-29`.
...
- The current date is `2026-03-29`. Any source dated after `2026-03-29` does
...
7. **Resolve aliases/entities** — reconcile names using only evidence available
   by `2026-03-29`. Do not use future aliases.
...
- Never read beyond `2026-03-29` in any feed or file.
