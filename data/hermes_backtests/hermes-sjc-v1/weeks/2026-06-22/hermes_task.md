...
**Simulation identity:** backtest `hermes-sjc-v1`, simulated week `2026-06-22` → `2026-06-28`.
...
- The current date is `2026-06-28`. Any source dated after `2026-06-28` does
...
7. **Resolve aliases/entities** — reconcile names using only evidence available
   by `2026-06-28`. Do not use future aliases.
...
- Never read beyond `2026-06-28` in any feed or file.
