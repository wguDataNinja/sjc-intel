...
**Simulation identity:** backtest `hermes-sjc-v1`, simulated week `2025-05-05` → `2025-05-11`.
...
- The current date is `2025-05-11`. Any source dated after `2025-05-11` does
...
7. **Resolve aliases/entities** — reconcile names using only evidence available
   by `2025-05-11`. Do not use future aliases.
...
- Never read beyond `2025-05-11` in any feed or file.
